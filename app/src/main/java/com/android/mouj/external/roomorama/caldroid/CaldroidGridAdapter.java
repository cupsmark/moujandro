package com.android.mouj.external.roomorama.caldroid;
...
public class CaldroidGridAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            if (squareTextViewCell) {
                cellView = (CellView) localInflater.inflate(R.layout.caldroid_square_date_cell, null);
            } else {
                cellView = (CellView) localInflater.inflate(R.layout.caldroid_normal_date_cell, null);
            }
        }
